...
import { CompositeProvider, EspnSportsProvider, FixtureSportsProvider, HackerNewsProvider, MockSportsProvider, SnookerOrgProvider, UsgsEarthquakeProvider } from "../../../packages/providers/src/index.js";
...
export const DEFAULT_ESPN_SOURCES: EspnSourceConfig[] = [
  ...
  { sport: "soccer", league: "aut.1" },
  { sport: "soccer", league: "sui.1" },
  { sport: "soccer", league: "den.1" },
  { sport: "soccer", league: "nor.1" },
  { sport: "soccer", league: "swe.1" },
  { sport: "soccer", league: "fifa.world" },
  { sport: "soccer", league: "fifa.worldq" },
  { sport: "soccer", league: "conmebol.libertadores" },
  { sport: "soccer", league: "conmebol.sudamericana" },
  { sport: "soccer", league: "afc.champions" },
  { sport: "soccer", league: "caf.champions" },
  { sport: "soccer", league: "concacaf.champions" },
  { sport: "basketball", league: "fiba" },
  { sport: "basketball", league: "nbl" },
...
export async function createProviderFromConfig(config: ProviderConfig = {}): Promise<HappeningProvider> {
  ...
  if (mode === "espn" || mode === "world") {
    ...
    if (mode === "world") {
      providers.push(new UsgsEarthquakeProvider(), new HackerNewsProvider(), new SnookerOrgProvider());
    }
